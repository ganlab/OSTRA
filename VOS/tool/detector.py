...
from tool.groundingdino.models import build_model as build_grounding_dino
from tool.groundingdino.util.slconfig import SLConfig
from tool.groundingdino.util.utils import clean_state_dict
from tool.groundingdino.util.inference import annotate, load_image, predict
import tool.groundingdino.datasets.transforms as T

from torchvision.ops import box_convert

class Detector:
    def __init__(self, device):
        config_file = "tool/groundingdino/config/GroundingDINO_SwinT_OGC.py"
        grounding_dino_ckpt = './checkpoints/groundingdino_swint_ogc.pth'

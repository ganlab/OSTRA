...
def eval_psnr(loader, model, data_norm=None, eval_type=None, eval_bsize=None,
    ...
    for batch in pbar:
        ...
        for p in range(pred.shape[0]):
            ...
            pil.save(f'/shared_file/SAM-Adapter-PyTorch-main/result/{result_name}/{cnt}.png')
            # pil = tensor2PIL(torch.tensor(batch['gt'][p]*255, dtype=torch.uint8))
            # pil.save(f'/shared_file/SAM-Adapter-PyTorch-main/result/G/{result_name}/{cnt}_gt.png')
            cnt += 1
